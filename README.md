...
If you have not already linked this repo to an Apps Script project:
...
Then make sure the project has a valid `.clasp.json` created in the repo root. This file is local to each developer environment and should not be committed unless your team intentionally shares a script ID.
